        ...
        <div class="bg-white rounded-2xl p-8 w-96 max-w-[90%]">
            ...
            <form onsubmit="return loginPelanggan(event)">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="pelangganEmail" placeholder="email@example.com" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 mb-2">Password</label>
        ...
        <div class="bg-white rounded-2xl p-8 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onsubmit="return registerPelanggan(event)">
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2">Email</label>
                        <input type="email" id="regEmail" placeholder="email@example.com" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500" required>
                    </div>
                    <div>
                        <label class="block text-gray-700 mb-2">Password</label>
                        <input type="password" id="regPassword" placeholder="Minimal 6 karakter" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500" required>
                    </div>
                    <div>
