        ...
        <form onsubmit="event.preventDefault(); bookingSelesai();">
            ...
            <div class="bg-gray-50 rounded-lg p-3 mb-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="text" id="pelangganNama" placeholder="Masukkan nama lengkap" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold mb-1">Email <span class="text-red-500">*</span></label>
                        <input type="email" id="pelangganEmail" placeholder="email@example.com" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold mb-1">No. Handphone (WhatsApp) <span class="text-red-500">*</span></label>
                        <input type="tel" id="pelangganNoHp" placeholder="081234567890" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-3 mb-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-semibold mb-1">Tanggal Mulai <span class="text-red-500">*</span></label>
                        <input type="date" id="tanggalMulai" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold mb-1">Tanggal Kembali <span class="text-red-500">*</span></label>
                        <input type="date" id="tanggalKembali" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold mb-1">Jumlah <span class="text-red-500">*</span></label>
                        <input type="number" id="jumlahBooking" value="1" min="1" class="w-full border rounded-lg px-3 py-2 text-sm" required>
                    </div>
                </div>
            </div>
                ...
                <div class="flex gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-yellow-600 mt-1">
                            ⚠️ KTP asli akan diserahkan saat mengambil barang dan akan dikembalikan setelah barang dikembalikan dengan kondisi baik.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="flex-1 bg-green-600 text-white py-2 rounded-lg font-semibold hover:bg-green-700">
                    <i class="fas fa-check-circle mr-1"></i> Konfirmasi Booking
                </button>
                <button type="button" onclick="closeModal('bookingModal')" class="flex-1 bg-gray-300 text-gray-700 py-2 rounded-lg font-semibold hover:bg-gray-400">
                    Batal
                </button>
            </div>
        </form>
    ...
    <div class="bg-white rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-purple-50 rounded-lg p-4 border border-purple-200">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex items-center gap-2">
                        ...
                        <span><span class="font-semibold">Tunai:</span> Bayar langsung saat mengambil barang</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-qrcode text-blue-600"></i>
                        <span><span class="font-semibold">QRIS:</span> Scan QR code (OVO, DANA, ShopeePay, dll)</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-university text-red-600"></i>
                        <span><span class="font-semibold">Transfer Bank:</span> BCA 8210914073 a.n AKA Rental</span>
                    </div>
                </div>
            ...
            <a href="#" id="whatsappLink" target="_blank" 
               class="block w-full bg-green-600 text-white py-2 rounded-lg font-semibold hover:bg-green-700 text-center">
                <i class="fab fa-whatsapp mr-1"></i> Konfirmasi ke Admin via WhatsApp
            </a>
            
            <button onclick="closeModal('konfirmasiModal')" class="w-full bg-gray-300 text-gray-700 py-2 rounded-lg font-semibold hover:bg-gray-400">
                Tutup
            </button>
        </div>
    </div>
...
function bookingSelesai() {
    ...
    // Isi detail ke modal konfirmasi
